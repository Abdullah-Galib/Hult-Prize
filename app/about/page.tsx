    ...
    <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white mb-6">
          About <span className="text-[#E6007F]">Us</span>
        </h1>
      </div>

      {/* Content Section with Glassmorphism */}
      <div className="bg-white/80 dark:bg-[#131B2F]/80 backdrop-blur-2xl border border-slate-200 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 pt-8 mt-8 border-t border-slate-200 dark:border-white/10">
          ...
          <div className="bg-slate-50 dark:bg-white/5 p-6 rounded-2xl border border-slate-100 dark:border-white/5">
            <h3 className="text-[#FFDA00] font-bold text-xl mb-3">
              Our Mission
            </h3>
          ...
          <div className="bg-slate-50 dark:bg-white/5 p-6 rounded-2xl border border-slate-100 dark:border-white/5">
            <h3 className="text-[#E6007F] font-bold text-xl mb-3">
              Our Vision
            </h3>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed text-justify">
