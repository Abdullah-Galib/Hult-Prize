    ...
    <div className="mx-auto max-w-7xl px-6 py-12 md:py-20">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">
          Partnership <span className="text-brand-pink">Proposal</span>
        </h1>
        ...
        <div className="space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a 
              ...
              className="inline-flex items-center justify-center gap-2 bg-brand-yellow text-slate-900 px-5 py-2.5 rounded-full font-bold hover:bg-brand-pink hover:text-white transition-all shadow-md"
            >
          ...
          <div className="w-full aspect-video bg-white dark:bg-navy-light rounded-3xl border border-slate-200 dark:border-white/10 shadow-2xl overflow-hidden relative group p-2">
            <div className="w-full h-full rounded-2xl overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-navy -z-10">
          ...
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-xl p-8 rounded-3xl border border-slate-200 dark:border-white/10 shadow-lg">
            ...
            <ul className="space-y-3 text-slate-800 dark:text-slate-200 font-medium">
              <li className="flex items-center gap-3"><span className="text-brand-pink text-xl">✓</span> Access to 500+ top student innovators.</li>
              <li className="flex items-center gap-3"><span className="text-brand-pink text-xl">✓</span> Premium brand visibility across campus.</li>
              <li className="flex items-center gap-3"><span className="text-brand-pink text-xl">✓</span> Direct alignment with UN Sustainable Development Goals.</li>
            </ul>
          </div>
        </div>
